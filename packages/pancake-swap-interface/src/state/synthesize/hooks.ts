...
export function useSynthesizeState(): AppState['synthesize'] {
  return useSelector<AppState, AppState['synthesize']>((state) => state.synthesize)
}

export function useDerivedSynthesizeInfo(
...
export function useSynthesizeActionHandlers(): { onInput: (value: string) => void } {
