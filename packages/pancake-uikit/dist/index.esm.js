...
var templateObject_1$R, templateObject_2$j, templateObject_3$9;
...
var templateObject_1$L, templateObject_2$i, templateObject_3$8, templateObject_4$4;
...
var SliderLabel = styled(Text)(templateObject_1$m || (templateObject_1$m = __makeTemplateObject(["\n  bottom: 0;\n  font-size: 12px;\n  left: calc(", "%);\n  position: absolute;\n  margin-left: 16px; // offset the bunny butt width\n"], ["\n  bottom: 0;\n  font-size: 12px;\n  left: calc(", "%);\n  position: absolute;\n  margin-left: 16px; // offset the bunny butt width\n"])), function (_a) {
    var progress = _a.progress;
    return progress;
});
styled.img(templateObject_2$a || (templateObject_2$a = __makeTemplateObject(["\n  position: absolute;\n"], ["\n  position: absolute;\n"])));
...
var templateObject_1$m, templateObject_2$a, templateObject_3$7, templateObject_4$3, templateObject_5$3, templateObject_6;
...
var StyledSlider = styled(Box)(templateObject_1$l || (templateObject_1$l = __makeTemplateObject(["\n  opacity: ", ";\n"], ["\n  opacity: ", ";\n"])), function (_a) {
    var isDisabled = _a.isDisabled;
    return (isDisabled ? ".5" : 1);
});
...
var Slider = function (_a) {
    var name = _a.name, min = _a.min, max = _a.max, value = _a.value, onValueChanged = _a.onValueChanged, valueLabel = _a.valueLabel, _b = _a.step, step = _b === void 0 ? "any" : _b, _c = _a.isDisabled, isDisabled = _c === void 0 ? false : _c, props = __rest(_a, ["name", "min", "max", "value", "onValueChanged", "valueLabel", "step", "isDisabled"]);
    ...
    return (React.createElement(StyledSlider, __assign({ position: "relative", height: "48px", isDisabled: isDisabled }, props),
        ...
        React.createElement(BunnySlider, null,
            ...
            React.createElement(BarProgress, { isMax: isMax, progress: progressPercentage, style: { width: isMax ? "calc(100% - 16px)" : progressPercentage + "%" } }),
            React.createElement(StyledInput, { name: name, type: "range", min: min, max: max, value: value, step: step, onChange: handleChange, isMax: isMax, disabled: isDisabled })),
