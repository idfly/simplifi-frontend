...
var SliderLabel = styled__default['default'](Text)(templateObject_1$m || (templateObject_1$m = __makeTemplateObject(["\n  bottom: 0;\n  font-size: 12px;\n  left: calc(", "%);\n  position: absolute;\n  margin-left: 16px; // offset the bunny butt width\n"], ["\n  bottom: 0;\n  font-size: 12px;\n  left: calc(", "%);\n  position: absolute;\n  margin-left: 16px; // offset the bunny butt width\n"])), function (_a) {
    var progress = _a.progress;
    return progress;
});
styled__default['default'].img(templateObject_2$a || (templateObject_2$a = __makeTemplateObject(["\n  position: absolute;\n"], ["\n  position: absolute;\n"])));
...
var StyledSlider = styled__default['default'](Box)(templateObject_1$l || (templateObject_1$l = __makeTemplateObject(["\n  opacity: ", ";\n"], ["\n  opacity: ", ";\n"])), function (_a) {
...
var Slider = function (_a) {
    ...
    return (React__default['default'].createElement(StyledSlider, __assign({ position: "relative", height: "48px", isDisabled: isDisabled }, props),
        ...
        React__default['default'].createElement(BunnySlider, null,
            ...
            React__default['default'].createElement(BarProgress, { isMax: isMax, progress: progressPercentage, style: { width: isMax ? "calc(100% - 16px)" : progressPercentage + "%" } }),
            React__default['default'].createElement(StyledInput, { name: name, type: "range", min: min, max: max, value: value, step: step, onChange: handleChange, isMax: isMax, disabled: isDisabled })),
